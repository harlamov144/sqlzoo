...
-- You should include Mexico City as it is longer than Mexico. You should not include Luxembourg as the capital is
...
where capital = name||REPLACE(capital, name,'') and name != capital
